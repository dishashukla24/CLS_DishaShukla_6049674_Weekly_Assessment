...
import com.example.springbootmvc.exception.DuplicateLoanApplicationException;
import com.example.springbootmvc.exception.InvalidLoanAmountException;
import com.example.springbootmvc.exception.LoanNotFoundException;
import com.example.springbootmvc.repository.LoanRepository;
...
public class LoanServiceImpl implements LoanService {
    ...
    public Loan updateLoanStatus(Long id, String status) {
        ...
        Loan loan = repo.findById(id).orElseThrow(() -> new LoanNotFoundException("Loan not found with id: " + id));
